    ...
    <div id="app" class="container mx-auto py-10">
        <div class="sm:flex sm:items-center px-6 py-4 w-full h-full">
            <div class="text-center font-serif sm:flex-grow">
                ...
                <div
                    class="flex flex-row flex-wrap items-stretch items-end content-start"
                >
                    <div class="flex-1 w-full">
                        <p class="inline text-xl leading-tight">tänään</p>
                        <p
                            class="inline ml-4 mr-4 text-6xl leading-tight font-sans"
                        >
                            <IOdometer
                                class="m-0"
                                :value="resignedToday"
                    ...
                    <div class="flex-1 w-full">
                        <p class="inline text-xl leading-tight">
                            tällä viikolla
                        </p>
                        <p
                            class="inline ml-4 mr-4 text-6xl leading-tight font-sans"
